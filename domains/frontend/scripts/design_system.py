...
# brain-local security patch: slugify names used in filesystem paths so a project/page
# name containing "/" or ".." can't escape the design-system/ output dir (reachable via
